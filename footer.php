	...
	<footer>
		<div class="container">
			...
			?>
			<p>Built on the <a href="http://whiteboardframework.com/">Whiteboard Framework for Wordpress</a>, by <a href="http://boldperspective.com/">Bold Perspective</a>. Powered by <a href="http://wordpress.org">Wordpress</a>.</p>
		</div><!--.container-->
	</footer>
</div><!--#main-->
